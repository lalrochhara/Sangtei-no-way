...
from Sangtei import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
...
from Sangtei.modules.sql.afk_sql import is_afk, check_afk_status
from Sangtei.modules.sql.users_sql import get_user_num_chats
from Sangtei.modules.sql.feds_sql import get_user_fbanlist
...
from Sangtei import telethn as SangteiTelethonClient, TIGERS, DRAGONS, DEMONS
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/SangteiBot/19">?</a>]'.format(
            bot.username)
 ...
 *What Health means?*
  Come and see [HP System explained](https://t.me/SangteiUpdates/24).
"""
