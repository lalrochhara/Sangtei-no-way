...
from Sangtei import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
...
def export_data(update, context):
    ...
    with open("Sangtei{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        ...
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Sangtei` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
