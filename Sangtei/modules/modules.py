...
from Sangtei import dispatcher, telethn
from Sangtei.__main__ import (CHAT_SETTINGS, DATA_EXPORT, DATA_IMPORT,
...
def load(update: Update, context: CallbackContext):
    ...
    try:
        imported_module = importlib.import_module("Sangtei.modules." +
                                                  text)
    except:
